...
* minor
** TODO when leftmost arg of a placeholder is a row, compose
r x y f p -> r x y f ap20 .
T_FUNCTION, & T_LIST | T_ROW related
leftmost of the list can be a function
** STARTED leftmost ptr in a list can be a row
*** TODO pass tests
*** TODO make quote return a function with a row arg
*** TODO fix pushl into quote function (in compose_arg)
...
** DONE add string map
* bugs
** TODO [1 3] 2 pushr popr swap popr swap popr swap popr
** TODO imports don't always work
