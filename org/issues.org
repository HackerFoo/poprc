...
**** split_args
* major
** TODO every cell has a pointer to previous item in stack/list at arg[0] (left arg)
fixes map_assert
...
** TODO overhaul byte_compile to use variable ids
** TODO don't trace pushl/pushr/popr again, let assertion mapping enforce assertions
